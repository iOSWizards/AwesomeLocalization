...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AwesomeLocalization.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/eharrison/AwesomeLocalization'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'eharrison' => 'evandro@itsdayoff.com' }
  s.source           = { :git => 'https://github.com/eharrison/AwesomeLocalization.git', :tag => s.version.to_s }
